...
# Plot using ggplot2
ggplot(counts, aes(x = Gender, y = percentage, fill = mental_health_consequence)) +
  geom_bar(stat = "identity", position = "stack") +
  labs(title = "Do you think that discussing a mental health issue\n with your employer would have negative consequences?",
       x = "Geschlecht",
       y = "Prozent",
       fill = "Mental Health Consequence") +
