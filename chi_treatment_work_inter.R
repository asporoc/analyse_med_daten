...
contingency_table <- table(data_clean$treatment, data_clean$work_interfere)
...
ggplot(df, aes(Var1, Freq, fill = Var2)) +
  ...
  labs(x = "Treatment", y = "Frequency", fill = "Work Interfere") +
  ggtitle("Contingency Table of Treatment and Work Interfere") +
