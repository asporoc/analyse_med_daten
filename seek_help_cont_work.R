...
contingency_table <- table(data_clean$seek_help, data_clean$work_interfere)
...
ggplot(df, aes(Var1, Freq, fill = Var2)) +
  ...
  labs(x = "Seek help", y = "Frequency", fill = "Work Interfere") +
  ggtitle("Contingency Table of Seek help and Work Interfere") +
